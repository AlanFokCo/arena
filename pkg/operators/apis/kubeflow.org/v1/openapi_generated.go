...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.ElasticPolicy":       schema_pkg_apis_kubefloworg_v1_ElasticPolicy(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.MPIJob":              schema_pkg_apis_kubefloworg_v1_MPIJob(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.MPIJobList":          schema_pkg_apis_kubefloworg_v1_MPIJobList(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.MPIJobSpec":          schema_pkg_apis_kubefloworg_v1_MPIJobSpec(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.MXJob":               schema_pkg_apis_kubefloworg_v1_MXJob(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.MXJobList":           schema_pkg_apis_kubefloworg_v1_MXJobList(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.MXJobSpec":           schema_pkg_apis_kubefloworg_v1_MXJobSpec(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.MXJobStatus":         schema_pkg_apis_kubefloworg_v1_MXJobStatus(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.PaddleElasticPolicy": schema_pkg_apis_kubefloworg_v1_PaddleElasticPolicy(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.PaddleJob":           schema_pkg_apis_kubefloworg_v1_PaddleJob(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.PaddleJobList":       schema_pkg_apis_kubefloworg_v1_PaddleJobList(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.PaddleJobSpec":       schema_pkg_apis_kubefloworg_v1_PaddleJobSpec(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.PyTorchJob":          schema_pkg_apis_kubefloworg_v1_PyTorchJob(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.PyTorchJobList":      schema_pkg_apis_kubefloworg_v1_PyTorchJobList(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.PyTorchJobSpec":      schema_pkg_apis_kubefloworg_v1_PyTorchJobSpec(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.RDZVConf":            schema_pkg_apis_kubefloworg_v1_RDZVConf(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.TFJob":               schema_pkg_apis_kubefloworg_v1_TFJob(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.TFJobList":           schema_pkg_apis_kubefloworg_v1_TFJobList(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.TFJobSpec":           schema_pkg_apis_kubefloworg_v1_TFJobSpec(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.XGBoostJob":          schema_pkg_apis_kubefloworg_v1_XGBoostJob(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.XGBoostJobList":      schema_pkg_apis_kubefloworg_v1_XGBoostJobList(ref),
		"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.XGBoostJobSpec":      schema_pkg_apis_kubefloworg_v1_XGBoostJobSpec(ref),
	}
}
...
func schema_pkg_apis_kubefloworg_v1_ElasticPolicy(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.RDZVConf"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.RDZVConf", "k8s.io/api/autoscaling/v2.MetricSpec"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_MPIJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.MPIJobSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kubeflow/common/pkg/apis/common/v1.JobStatus", "github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.MPIJobSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_MPIJobList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.MPIJob"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.MPIJob", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_MXJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.MXJobSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kubeflow/common/pkg/apis/common/v1.JobStatus", "github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.MXJobSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_MXJobList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.MXJob"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.MXJob", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_PaddleJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.PaddleJobSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kubeflow/common/pkg/apis/common/v1.JobStatus", "github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.PaddleJobSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_PaddleJobList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.PaddleJob"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.PaddleJob", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_PaddleJobSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"elasticPolicy": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.PaddleElasticPolicy"),
						},
					},
					"paddleReplicaSpecs": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kubeflow/common/pkg/apis/common/v1.ReplicaSpec", "github.com/kubeflow/common/pkg/apis/common/v1.RunPolicy", "github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.PaddleElasticPolicy"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_PyTorchJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.PyTorchJobSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kubeflow/common/pkg/apis/common/v1.JobStatus", "github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.PyTorchJobSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_PyTorchJobList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.PyTorchJob"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.PyTorchJob", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_PyTorchJobSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"elasticPolicy": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.ElasticPolicy"),
						},
					},
					"pytorchReplicaSpecs": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kubeflow/common/pkg/apis/common/v1.ReplicaSpec", "github.com/kubeflow/common/pkg/apis/common/v1.RunPolicy", "github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.ElasticPolicy"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_TFJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.TFJobSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kubeflow/common/pkg/apis/common/v1.JobStatus", "github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.TFJobSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_TFJobList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.TFJob"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.TFJob", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_XGBoostJob(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.XGBoostJobSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kubeflow/common/pkg/apis/common/v1.JobStatus", "github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.XGBoostJobSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_kubefloworg_v1_XGBoostJobList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.XGBoostJob"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubeflow/arena/pkg/operators/apis/kubeflow.org/v1.XGBoostJob", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
